...
@Schema(name="Empschm EmpositionKeys",description = "Represents the primary or selected unique keys for the EMPSCHM.EMPOSITION table")
public class EmpositionKeys {
