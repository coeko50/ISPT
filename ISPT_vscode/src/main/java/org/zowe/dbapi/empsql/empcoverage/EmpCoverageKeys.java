...
@Schema(name="Empsql EmpCoverageKeys",description = "Represents the primary or selected unique keys for the EMPSQL.EMP_COVERAGE table")
public class EmpCoverageKeys {
