package org.zowe.dbapi.eafDemo.LDM54.exceptions;
...
public class DuplicateJobStandardException extends RuntimeException {
	...
	public DuplicateJobStandardException(String jobStdNr) {
		super("Job standard" + jobStdNr + "exists alteady");
	}
}
